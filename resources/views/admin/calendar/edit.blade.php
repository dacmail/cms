...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ route('admin::calendar::edit', ['id' => $event->id]) }}">Editar evento</a>
    </li>
@stop
    ...
    <div class="col-md-12">
        <div class="portlet light bordered form-fit">
            <div class="portlet-body form">
                <form action="{{ route('admin::calendar::update', ['id' => $event->id]) }}" method="POST" class="form-horizontal form-bordered form-label-stripped">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="start_date" value="{{ $event->start_date->format('d-m-Y H:i:s') }}" class="form-control datetimepicker">
                    ...
                    <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="end_date" value="{{ $event->end_date->format('d-m-Y H:i:s') }}" class="form-control datetimepicker">
                    ...
                    <div class="form-group {{ $errors->has('all_day') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <select name="all_day" class="form-control" required>
                                ...
                                <option value="1" {{ $event->all_day ? 'selected' : '' }}>Si</option>
                            </select>
                        ...
                        <div class="col-md-10">
                            <select name="type" class="form-control" required>
                                ...
                                @foreach(config('protecms.calendar.type') as $type)
                                    <option value="{{ $type }}" {{ $event->type == $type ? 'selected' : '' }}>{{ trans('calendar.type.' . $type) }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-10">
                            <textarea name="description" class="form-control tinymce">{{ $event->description }}</textarea>
