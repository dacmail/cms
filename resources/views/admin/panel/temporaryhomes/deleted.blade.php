...
@section('page.help.text')
    <p>Esta página muestra el listado de casas de acogida eliminadas de la protectora.</p>
    ...
    <p>Haciendo clic en el siguiente botón se recuperará la casa de acogida y aparecerá en el listado de casas de acogida.</p>
    <p><button class="btn btn-primary"><i class="fa fa-history"></i></button></p>
    <p class="bg-info">Las casas de acogida que permanezcan más de 30 días eliminados, se eliminarán de forma permanente.</p>
@stop