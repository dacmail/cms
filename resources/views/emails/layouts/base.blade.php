                            ...
                            <tr>
                                <td width="600" class="mobile" style="font-family:arial; font-size:12px; line-height:18px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container">
                                        ...
                                        <tr>
                                            <td class="mobile" style="font-size:18px; line-height:18px;">
                                                @yield('title')
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <table width="640" cellpadding="0" cellspacing="0" border="0" class="wrapper" bgcolor="#F6F6F6">
                ...
                <tr>
                    <td align="center">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                            <tr>
                                <td width="100%" class="mobile" style="font-family:arial; font-size:12px; line-height:18px;" align="center">
                                    Correo electrónico generado automáticamente por el sistema. No responda por favor.
                                </td>
                            </tr>
                        </table>
                    </td>
